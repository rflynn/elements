...
elements = [
    ...
    Element(  3, "Li", "Lithium",      "6.941(2)",       Group.Metal.Alkali,     (0xcf,0xcf,0xcf)),
    Element(  4, "Be", "Beryllium",    "9.012182(3)",    Group.Metal.AlkaliEarth),
    Element(  5, "B",  "Boron",        "10.811(7)",      Group.Metal.Metalloid),
    Element(  6, "C",  "Carbon",       "12.0107(8)",     Group.NonMetal,         (0x50,0x50,0x50)),
    ...
    Element( 37, "Rb", "Rubidium",     "85.4678(3)",     Group.Metal.Alkali),
